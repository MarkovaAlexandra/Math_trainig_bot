...
import random
from Keyboard import create_kb_div100
...
@dp.callback_query_handler(callback.filter(btn='next_div100'))
@dp.callback_query_handler(callback.filter(menu='div_up100'))
